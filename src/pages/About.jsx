  ...
  return (
    ...
    <Navbar />
        ...
        <div className=" w-[800px] flex flex-col gap-10 px-20 pt-10">
          ...
          <span className="font-medium">Newgen Research Consultancy</span> is a dynamic IT consultancy firm committed to fostering <span className="font-medium">research excellence</span>, <span className="font-medium">academic collaboration</span>, and <span className="font-medium">startup growth</span>. We specialize in organizing international conferences, skill development workshops, and mentorship programs at universities and institutions, providing researchers and students with the platform to contribute to intellectual capital.
          </p>
<p>Beyond academia, we actively support <span className="font-medium">young startups</span>, offering strategic <span className="font-medium">guidance</span>, <span className="font-medium">funding</span>, and  <span className="font-medium">handholding</span> to help them build a strong foundation. With a network of like-minded professionals, we are dedicated to nurturing talent, fostering innovation, and creating societal impact.
</p>
          ...
          <button className='bg-blue-500 px-6 py-2 w-max rounded-full text-xl font-medium text-white cursor-pointer'>Message</button>
        </div>
      </div>
      <Footer />
    </>
